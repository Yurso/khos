...
<form method="post" action="/admin/realty/customers" class="adminform" name="itemsForm">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align:left;">
                    <a href="/admin/realty/customers/edit/<?php echo $item->id; ?>"><?php echo $item->name; ?></a>
                </td>  
    ...
    <div class="buttons">
    	<a href="/admin/realty/customers/create" title="Создать новый элемент">Создать</a>
