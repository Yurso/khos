...
<form method="post" action="/admin/tasks/reports" class="adminform" name="itemsForm">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align:left;">
                    <a href="/admin/tasks/reports/edit/<?php echo $item->id; ?>"><?php echo $item->title; ?></a>
                </td>                
    ...
    <div class="buttons">
    	<a href="/admin/tasks/reports/create" title="Создать новый элемент">Создать</a>
