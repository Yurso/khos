...
(function($){
		...
		this.opts = $.extend({
			...
			modal_image_edit: String() +
				...
				'<select id="redactor_form_image_align">' +
					...
					'<option value="center">' + RLANG.center + '</option>' + // Yurso addon
	...
	Redactor.prototype = {
		...
		imageSave: function(el)
		{
			...
			else if (floating === 'center') // Yurso addon
			{ // Yurso addon
				$(el).css({ 'float': 'none', 'display': 'block',  margin: '0 auto' }); // Yurso addon
			} // Yurso addon
			else
			{
